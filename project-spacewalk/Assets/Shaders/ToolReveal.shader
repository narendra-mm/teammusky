...
Shader "Spacewalk/ToolReveal"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 ifLocalVar124 = 0;
			if( ase_lightColor.a <= _Intensity )
				ifLocalVar124 = color126;
			else
				ifLocalVar124 = ase_lightColor;
			float3 normalizeResult116 = normalize( (( ifLocalVar124 * _WorldSpaceLightPos0.w )).rgb );
...
/*ASEBEGIN
Version=17700
2112;22;1473;990;1997.178;61.04309;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;125;-1553.178,425.9569;Inherit;False;Property;_Intensity;Intensity;5;0;Create;True;0;0;False;0;0;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightAttenuation;53;-984.7832,-95.32682;Inherit;True;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;79;-497.2228,-258.412;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D493CCFD57F3C56408231BF44F5023BDE20555DF