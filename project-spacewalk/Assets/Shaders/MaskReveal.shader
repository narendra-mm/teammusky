...
Shader "Spacewalk/MaskReveal"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_output_55_0 = ( temp_output_59_0 * _WorldSpaceLightPos0.w );
			float4 temp_output_78_0 = ( ( tex2D( _BaseTexture, uv_BaseTexture ) * float4( 0,0,0,0 ) ) + ( tex2D( _Tool1Mask, uv_Tool1Mask ) * temp_output_55_0 ) );
			c.rgb = temp_output_78_0.rgb;
			c.a = (temp_output_78_0).a;
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float4 temp_output_59_0 = ( 1 * ase_lightColor );
			float4 temp_output_55_0 = ( temp_output_59_0 * _WorldSpaceLightPos0.w );
			float4 temp_output_78_0 = ( ( tex2D( _BaseTexture, uv_BaseTexture ) * float4( 0,0,0,0 ) ) + ( tex2D( _Tool1Mask, uv_Tool1Mask ) * temp_output_55_0 ) );
...
/*ASEBEGIN
Version=17700
2112;22;1473;990;2093.07;1181.645;2.595787;True;True
...
Node;AmplifyShaderEditor.SamplerNode;51;-760.7654,-475.1937;Inherit;True;Property;_BaseTexture;Base Texture;0;0;Create;True;0;0;False;0;-1;None;8830f8b75590ec84cb55507178b207cc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;52;-456.3876,-160.8523;Inherit;True;Property;_Tool1Mask;Tool1Mask;1;0;Create;True;0;0;False;0;-1;None;904734cab9223b54ea359bcca649a7b3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;78;484.5206,-56.7467;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;79;-617.5732,-273.9497;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;125;-1553.178,425.9569;Inherit;False;Property;_Intensity;Intensity;4;0;Create;True;0;0;False;0;0;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;128;540.6987,-261.374;Inherit;False;False;False;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=B1F2C8A5FEB4644EA35C4B565DB577EC87E25A76